...
### Backend Rendering
To use the [integrated UIX backend rendering](https://docs.unyt.org/manual/uix/rendering-methods), with hydration enabled by default, you can use the `backend/entrypoint.tsx` module to prerender your HTML on the server. The syntax remains the same.
